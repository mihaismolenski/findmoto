...
export const MotoDetails = ({ data, handleClose }: MotoDetailsProps) => {
  ...
  return (
    <div className="moto-details">
      ...
      <div className="moto-details-title">
        {make} {model}
      </div>
      ...
      <fieldset className="moto-details-box">
        ...
        {fuel_consumption && (
          <div className="moto-details-spec">
            <img
              src="../images/fuel_consumption.png"
              width="24px"
              height="24px"
              alt="engine"
            />{" "}
            <b>Fuel consumption:</b> {fuel_consumption}
          </div>
        )}
        {emission && (
          <div className="moto-details-spec">
            <img
              src="../images/emission.png"
              width="24px"
              height="24px"
              alt="engine"
            />{" "}
        ...
        {fuel_capacity && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />{" "}
            <b>Fuel capacity:</b> {fuel_capacity}
          </div>
        )}
        {starter && (
          <div className="moto-details-spec">
      ...
      <fieldset className="moto-details-box">
        ...
        {valves_per_cylinder && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />
            <b>Valves per cylinder:</b> {valves_per_cylinder}
          </div>
        )}
        {fuel_system && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />
            <b>Fuel system:</b> {fuel_system}
          </div>
        )}
        {fuel_control && (
          <div className="moto-details-spec">
            <img
              src="../images/fuel_control.png"
              width="24px"
              height="24px"
              alt="engine"
            />
            <b>Fuel control:</b> {fuel_control}
          </div>
        )}
        {ignition && (
          <div className="moto-details-spec">
        ...
        {bore_stroke && (
          <div className="moto-details-spec">
            <img
              src="../images/bore_stroke.png"
              width="24px"
              height="24px"
              alt="engine"
            />
            <b>Bore stroke:</b> {bore_stroke}
          </div>
        )}
        {compression && (
          <div className="moto-details-spec">
      ...
      <fieldset className="moto-details-box">
        <legend className="moto-details-label">
        ...
        {rear_brakes && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />{" "}
            <b>Rear brakes:</b> {rear_brakes}
          </div>
        )}
        {front_wheel_travel && (
          <div className="moto-details-spec">
            <img
              src="../images/wheeltravel.png"
              width="24px"
              height="24px"
              alt="engine"
            />{" "}
            <b>Front wheel travel:</b> {front_wheel_travel}
          </div>
        )}
        {rear_wheel_travel && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />{" "}
            <b>Rear wheel travel:</b> {rear_wheel_travel}
          </div>
        )}
        {front_suspension && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />{" "}
            <b>Front suspension:</b> {front_suspension}
          </div>
        )}
        {rear_suspension && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />{" "}
            <b>Rear suspension:</b> {rear_suspension}
          </div>
        )}
      </fieldset>
        ...
        {total_width && (
          <div className="moto-details-spec">
            <img
              ...
              alt="engine"
            />{" "}
            <b>Width:</b> {total_width}
          </div>
        )}
        {ground_clearance && (
          <div className="moto-details-spec">
            <img
              src="../images/ground_clearance.png"
              width="24px"
              height="24px"
              alt="engine"
            />{" "}
            <b>Ground clearance:</b> {ground_clearance}
          </div>
        )}
        {wheelbase && (
          <div className="moto-details-spec">
            <img
              src="../images/wheelbase.png"
              width="24px"
              height="24px"
              alt="engine"
            />{" "}
            <b>Wheelbase:</b> {wheelbase}
          </div>
        )}
      </fieldset>
      ...
      <fieldset className="moto-details-box">
        <legend className="moto-details-label">Price</legend>
        <Prices make={make} model={model} year={year} />
      </fieldset>
    </div>
  );
};
